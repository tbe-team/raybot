...
| 3    | uint8        | Trạng thái cửa                  |
| 4    | uint8        | Trạng thái động cơ đóng mở      |
| 5    | uint8        | Trạng thái QR                   |
| 6    | uint8        | Trạng thái cảm biến khoảng cách |
...
### 2.5. Trạng thái động cơ đóng mở
...
### 2.7. Trạng thái cảm biến khoảng cách dưới
