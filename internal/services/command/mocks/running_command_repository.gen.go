...
func (_m *FakeRunningCommandRepository) Update(ctx context.Context, cmd command.CancelableCommand) error {
	ret := _m.Called(ctx, cmd)
...
// FakeRunningCommandRepository_Update_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Update'
type FakeRunningCommandRepository_Update_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - cmd command.CancelableCommand
func (_e *FakeRunningCommandRepository_Expecter) Update(ctx interface{}, cmd interface{}) *FakeRunningCommandRepository_Update_Call {
	return &FakeRunningCommandRepository_Update_Call{Call: _e.mock.On("Update", ctx, cmd)}
}

func (_c *FakeRunningCommandRepository_Update_Call) Run(run func(ctx context.Context, cmd command.CancelableCommand)) *FakeRunningCommandRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(command.CancelableCommand))
	})
	return _c
...
func (_c *FakeRunningCommandRepository_Update_Call) Return(_a0 error) *FakeRunningCommandRepository_Update_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *FakeRunningCommandRepository_Update_Call) RunAndReturn(run func(context.Context, command.CancelableCommand) error) *FakeRunningCommandRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
